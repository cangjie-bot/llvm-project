...
private:
  ...
  void adjustForReuseByLiveInterval(Function &F, CandidateReuseMap &BitSizeToNoEscapeVals, FunctionVarLifeTimeResult &LifeTimeResult, CJAAResult &CJAARes);
  bool transformForMemReuse(FunctionVarLifeTimeResult &LifeTimeResult);
  bool isHeapZoneValue(Value *Val);
  bool runImpl(Function &F, FunctionVarLifeTimeResult &LifeTimeResult, CJAAResult &CJAARes);
  void clear();
