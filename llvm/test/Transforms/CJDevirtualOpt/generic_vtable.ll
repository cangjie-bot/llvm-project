...
@"default:B<T>_ed_default:A" = internal global %ExtensionDef { i32 1, i8 1, i8 -128, i16 1, i8* bitcast (%TypeTemplate* @"default:B.tt" to i8*), i8* bitcast (%TypeInfo* @"default:A.ti" to i8*), i8* null, i8* bitcast ([1 x i8*]* @"default:B<T>_ed_default:A.ft" to i8*) }
