...
declare i8 addrspace(1)* @CJ_MCC_NewArray64(i64, i8*)
...
; PEA: %5 = call i8 addrspace(1)* @CJ_MCC_NewArray64(i64 0, i8* bitcast (%TypeInfo* @"RawArray<Int64>.ti" to i8*))
; PEA: %6 = call i8 addrspace(1)* @CJ_MCC_NewArray64(i64 5000, i8* bitcast (%TypeInfo* @"RawArray<Int64>.ti" to i8*))
; PEA: %7 = call i8 addrspace(1)* @CJ_MCC_NewArray64(i64 33, i8* bitcast (%TypeInfo* @"RawArray<Int64>.ti" to i8*))
...
bb0:
  ...
  %1 = call i8 addrspace(1)* @CJ_MCC_NewArray64(i64 0, i8* bitcast (%TypeInfo* @"RawArray<Int64>.ti" to i8*))
  %2 = call i8 addrspace(1)* @CJ_MCC_NewArray64(i64 5000, i8* bitcast (%TypeInfo* @"RawArray<Int64>.ti" to i8*))
  %3 = call i8 addrspace(1)* @CJ_MCC_NewArray64(i64 33, i8* bitcast (%TypeInfo* @"RawArray<Int64>.ti" to i8*))
