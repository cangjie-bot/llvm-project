...
; %loadedval in LICM and avoid creation of an unreloc use of %baseaddr.
define void @test_invariant_load() gc "cangjie" {
; CHECK-LABEL: @test_invariant_load
; CHECK: %loadedval = load i32, i32 addrspace(1)* %baseaddr, align 8, !range !1
bb:
...
define void @test_noalias(i32 %x, i32 addrspace(1)* %p, i32 addrspace(1)* %q) gc "cangjie" {
; CHECK-LABEL: test_noalias
; CHECK: %y = load i32, i32 addrspace(1)* %q, align 16
; CHECK: gc.statepoint
; CHECK: %p.reloc
; CHECK-NEXT: %p.reloc.casted = bitcast i8 addrspace(1)* %p.reloc to i32 addrspace(1)*
; CHECK-NEXT: store i32 %x, i32 addrspace(1)* %p.reloc.casted, align 16
entry:
...
define void @test_dereferenceable(i32 addrspace(1)* addrspace(1)* %p, i32 %x, i32 addrspace(1)* %q) gc "cangjie" {
...
define void @test_inv_start(i1 %cond, i32 addrspace(1)* addrspace(1)* %p, i32 %x, i32 addrspace(1)* %q) gc "cangjie" {
...
define void @test_inv_start2(i1 %cond, i32 addrspace(1)* addrspace(1)* %p, i32 %x, i32 addrspace(1)* %q) gc "cangjie" {
...
declare token @llvm.cj.gc.statepoint.p0f_isVoidi32f(i64, i32, void (i32)*, i32, i32, ...)

; Function Attrs: nounwind readonly
declare i8 addrspace(1)* @llvm.cj.gc.relocate.p1i8(token, i32, i32) #0

declare token @llvm.cj.gc.statepoint.p0f_isVoidf(i64, i32, void ()*, i32, i32, ...)
