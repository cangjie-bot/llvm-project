; REQUIRES: asserts
; RUN: opt < %s -disable-output -passes=cj-rewrite-statepoint

; We shouldn't crash when we encounter a vector phi with more than one input
; from the same predecessor.
define void @foo(<2 x i8 addrspace(1)*> %arg1, i32 %arg2, i1 %arg3, <2 x i64 addrspace(1)*> %arg4) gc "cangjie" personality i32* null {
bb:
