...
define void @test6(i64 addrspace(1)* %obj) gc "cangjie" {
; CHECK-LABEL: @test6
entry:
  br label %next
...
; CHECK-NEXT: bitcast
; CHECK-NEXT: @consume(i64 addrspace(1)* %obj.reloc.casted)
; CHECK-NEXT: @consume(i64 addrspace(1)* %obj.reloc.casted)
...
define void @test8() gc "cangjie" personality i32 ()* undef {
; CHECK-LABEL: test8
; CHECK-NOT: gc.statepoint
