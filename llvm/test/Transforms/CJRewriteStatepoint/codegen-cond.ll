...
define i1 @test(i8 addrspace(1)* %p, i1 %rare) gc "cangjie" {
; CHECK-LABEL: @test
entry:
...
define i1 @test2(i8 addrspace(1)* %p, i8 addrspace(1)* %q, i1 %rare) gc "cangjie" {
; CHECK-LABEL: @test2
entry:
...
define i1 @test3(i8 addrspace(1)* %p, i8 addrspace(1)* %q, i1 %rare) gc "cangjie" {
; CHECK-LABEL: @test3
; CHECK: gc.statepoint
; CHECK: %cond = icmp
; CHECK: br i1 %cond
