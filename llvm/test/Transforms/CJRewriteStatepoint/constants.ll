...
define i8 @test2(i8 addrspace(1)* %p) gc "cangjie" {
; CHECK-LABEL: @test2
; CHECK: gc.statepoint
...
define i8 @test3(i1 %always_true) gc "cangjie" {
; CHECK-LABEL: @test3
; CHECK: gc.statepoint
...
define i8 addrspace(1)* @test4(i8 addrspace(1)* %p) gc "cangjie" {
; CHECK-LABEL: @test4
entry:
...
; Globals don't move and thus don't get relocated
define i8 addrspace(1)* @test5(i1 %always_true) gc "cangjie" {
; CHECK-LABEL: @test5
; CHECK: gc.statepoint
...
define i8 addrspace(1)* @test6(i64 %arg) gc "cangjie" {
entry:
...
define i8 addrspace(1)* @test7(i64 %arg) gc "cangjie" {
entry:
...
define i8 @test8(i8 addrspace(1)* %p) gc "cangjie" {
...
define i8 @test9(i8 addrspace(1)* %p) gc "cangjie" {
...
define i8 @test10(i8 addrspace(1)* %p) gc "cangjie" {
...
define i32 addrspace(1)* @test11(i1 %c) gc "cangjie" {
; CHECK-LABEL: @test11
...
define <2 x i32 addrspace(1)*> @test12(i1 %c) gc "cangjie" {
; CHECK-LABEL: @test12
...
define <2 x i32 addrspace(1)*> @test13(i1 %c, <2 x i32 addrspace(1)*> %ptr) gc "cangjie" {
; CHECK-LABEL: @test13
...
entry:
  ...
  ; CHECK: %val.base = select i1 %c, <2 x i32 addrspace(1)*> %ptr, <2 x i32 addrspace(1)*> zeroinitializer, !is_base_value !1
  ; CHECK: gc.statepoint
  call void @foo() [ "deopt"() ]
