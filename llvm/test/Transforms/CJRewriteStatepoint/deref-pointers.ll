...
define i8 addrspace(1)* @test_deref_arg(i8 addrspace(1)* dereferenceable(4) %a) gc "cangjie" {
entry:
  call void @foo() [ "deopt"(i32 0, i32 -1, i32 0, i32 0, i32 0) ]
  ret i8 addrspace(1)* %a
}

define i8 addrspace(1)* @test_deref_or_null_arg(i8 addrspace(1)* dereferenceable_or_null(4) %a) gc "cangjie" {
entry:
  call void @foo() [ "deopt"(i32 0, i32 -1, i32 0, i32 0, i32 0) ]
  ret i8 addrspace(1)* %a
}

define i8 addrspace(1)* @test_noalias_arg(i8 addrspace(1)* noalias %a) gc "cangjie" {
entry:
  call void @foo() [ "deopt"(i32 0, i32 -1, i32 0, i32 0, i32 0) ]
  ret i8 addrspace(1)* %a
}

define i8 addrspace(1)* @test_deref_retval() gc "cangjie" {
...
define i8 addrspace(1)* @test_deref_or_null_retval() gc "cangjie" {
...
define i8 addrspace(1)* @test_noalias_retval() gc "cangjie" {
...
define i8 @test_md(i8 addrspace(1)* %ptr) gc "cangjie" {
; CHECK-LABEL: @test_md(
...
define i8 @test_md_new(i8 addrspace(1)* %ptr) gc "cangjie" {
...
define i8 addrspace(1)* @test_decl_only_attribute(i8 addrspace(1)* %ptr) gc "cangjie" {
...
define i8 addrspace(1)* @test_decl_only_noalias(i8 addrspace(1)* %ptr) gc "cangjie" {
...
define i8 addrspace(1)* @test_callsite_arg_attribute(i8 addrspace(1)* %ptr) gc "cangjie" {
