...
declare void @foo(%record3* noalias sret(%record3) %0)

define void @foo1(i8 addrspace(1)* %this, %record3 addrspace(1)* %0, i1 %cond) #0 gc "cangjie" {
entry:
  ...
  %6 = call i1 @CJ_MCC_IsInstanceOf(i8 addrspace(1)* %this, i8* bitcast (%KlassInfo.1* @"Klass1.objKlass" to i8*))
  call void @foo(%record3* noalias sret(%record3) %test0)
  %7 = getelementptr inbounds %record3, %record3* %test0, i64 0, i32 1
  %8 = getelementptr inbounds %record3, %record3* @Global0, i64 0, i32 1
  %sel = select i1 %cond, i8 addrspace(1)** %7, i8 addrspace(1)** %8
  call void @llvm.memcpy.p0p1i8.p0p1i8.i64(i8 addrspace(1)** align 8 %sel, i8 addrspace(1)** align 8 %8, i64 8, i1 false)
  ret void
}
