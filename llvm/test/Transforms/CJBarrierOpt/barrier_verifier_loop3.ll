...
begin:                                        ; preds = %entry, %end0
  %test = phi i8 [%test2, %entry], [%test.1, %end0]
...
body:                                         ; preds = %thunk0, %body
  ...
  call void @llvm.memcpy.p0p1i8.p0p1i8.i64(i8 addrspace(1)** align 8 %test4, i8 addrspace(1)** align 8 %7, i64 8, i1 false)
  %cond1 = icmp eq i8 %test, 0
  %test.1 = add i8 %test, 1
  call cangjiegccc void @MCC_SafepointStub()
  br i1 %cond1, label %body, label %end0

end0:                                         ; preds = %body
  br i1 %cond1, label %begin, label %end
