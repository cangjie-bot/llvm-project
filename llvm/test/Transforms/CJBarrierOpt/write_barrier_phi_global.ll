...
if:                                        ; preds = %entry
  ...
  %test4 = getelementptr inbounds %record3, %record3* @Global0, i64 0, i32 1
  br label %thunk

thunk:                                        ; preds = %if, %else
  %test5 = phi i8 addrspace(1)** [ %test3, %if ], [ %test4, %else ]
  br label %body

body:                                         ; preds = %thunk
  %test6 = call i1 @CJ_MCC_IsInstanceOf(i8 addrspace(1)* %this, i8* bitcast (%KlassInfo.1* @"Klass1.objKlass" to i8*))
  ...
  %test7 = call i1 @CJ_MCC_IsInstanceOf(i8 addrspace(1)* %this, i8* bitcast (%KlassInfo.1* @"Klass1.objKlass" to i8*))
  %6 = getelementptr inbounds %record3, %record3* @Global0, i64 0, i32 1
  call void @llvm.memcpy.p0p1i8.p0p1i8.i64(i8 addrspace(1)** align 8 %test5, i8 addrspace(1)** align 8 %6, i64 8, i1 false)
  ret void
}
