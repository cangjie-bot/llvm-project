...
; CHECK-NEXT:    str d12, [sp, #8]     // 8-byte Folded Spill
...
; CHECK-NEXT:    ldr d12, [sp, #8] // 8-byte Folded Reload
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    str x30, [sp, #-32]! // 8-byte Folded Spill
; CHECK-NEXT:    str d10, [sp, #8] // 8-byte Folded Spill
...
; CHECK-NEXT:	 ldr	d10, [sp, #8]                   // 8-byte Folded Reload
; CHECK-NEXT:	 ldr	x30, [sp], #32                  // 8-byte Folded Reload
; CHECK-NEXT:	 ret
