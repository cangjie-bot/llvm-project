...
void InstrWithLiveIntervalNode::print(raw_ostream &OS) const {
  OS << "InstrWithLiveIntervalNode::print\n";
}

#if !defined(NDEBUG) || defined(LLVM_ENABLE_DUMP)
LLVM_DUMP_METHOD void InstrWithLiveIntervalNode::dump() const { print(dbgs()); }
#endif
