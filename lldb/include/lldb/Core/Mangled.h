...
public:
  ...
  ConstString GetDemangledBaseName(const SymbolContext *sc = nullptr) const;
  ...
  ConstString GetName(NamePreference preference = ePreferDemangled, const SymbolContext *sc = nullptr) const;

  static std::string GetDemangledTypeName(std::string &type_name);
